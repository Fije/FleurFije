...
function createMiddleware(config, logger, fileWatcher) {
    ...
    middlewares.push(pluginTransformMiddleware_1.pluginTransformMiddleware(config, logger, fileWatcher));
    middlewares.push(pluginMimeTypeMiddleware_1.pluginMimeTypeMiddleware((_b = config.plugins) !== null && _b !== void 0 ? _b : []));
    middlewares.push(pluginServeMiddleware_1.pluginServeMiddleware((_c = config.plugins) !== null && _c !== void 0 ? _c : []));
    // serve static files
