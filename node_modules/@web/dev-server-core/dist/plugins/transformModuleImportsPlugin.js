...
async function transformModuleImportsWithPlugins(context, jsCode, rootDir, resolvePlugins) {
...
function transformModuleImportsPlugin(plugins, rootDir) {
    ...
    return {
        ...
        async transform(context) {
            ...
            if (context.response.is('js')) {
                const bodyWithResolvedImports = await transformModuleImportsWithPlugins(context, context.body, rootDir, importPlugins);
